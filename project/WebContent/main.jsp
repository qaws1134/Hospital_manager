...
<section style="position:absolute; top:30px;left:300px">
<form action="search.do">
	<select name ="searchName"size ="1">
		<option value="p_name">환자 이름</option>
		<option value="d_name">의사 이름</option>
		<option value="d_cls">병원 종류</option>
	</select>
...
<!-- 병실 정보 -->
<section style="position:absolute; top:80px;left:1150px">
<h4>병실 정보</h4>
      <table border="1" class="table table-striped">
      	<tr  class="success">
      		<td>병실 호수</td>
      	...
      	<c:forEach items="${D_inshow}" var="dto">
	      	<tr>
	      		<td>${dto.h_NUM}호</td>
	      		<td>${dto.d_NAME}</td>
	      		<td>${dto.h_COST}</td>
