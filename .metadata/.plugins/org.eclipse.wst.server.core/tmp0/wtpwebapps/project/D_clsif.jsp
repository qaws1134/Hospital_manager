...
<h4>부서별 월급</h4>
      <table border="1" class="table table-striped">
      	...
      	<c:forEach items="${D_clsif}" var="dto">
	      	<tr>
	      		<td>${dto.d_CLS}</td>
	      		<td>${dto.AVGCOST}</td>
	      		<td>${dto.MAXCOST}</td>
...
<form action="D_Search.do">
	<select name ="searchName"size ="1">
		<option value="d_name">의사 이름</option>
		<option value="d_cls">부서 이름</option>
	</select>
...
<section style="position:absolute; top:490px;left:300px">
      <table border="1" class="table table-striped">
      	...
      	<c:forEach items="${D_Search}" var="dto">
	      	<tr>
	      		<td>${dto.d_NAME}</td>
	      		<td>${dto.d_CLS}</td>
	      	</tr>
...
<section style="position:absolute; top:80px;left:700px">
<h4>의사 정보</h4>
     <table border="1" class="table table-striped">
      	<tr  class="success">
      		<td>의사 번호</td>
...
<!-- 내과 부서에 속해있는 의사가 담당하는 병실들 -->

<!-- 내과 
<section style="position:absolute; top:380px;left:300px">
      <table border="1">
      	...
      	<c:forEach items="${D_clshnea}" var="dto">
	      	<tr>
	      		<td>${dto.d_NUM}</td>
	      		<td>${dto.h_NUM}</td>
	      	</tr>
...
<section style="position:absolute; top:380px;left:500px">
      <table border="1">
      	...
      	<c:forEach items="${D_clshwhy}" var="dto">
	      	<tr>
	      		<td>${dto.d_NUM}</td>
	      		<td>${dto.h_NUM}</td>
	      	</tr>
...
<!-- 안과
<section style="position:absolute; top:380px;left:700px">
      <table border="1">
      	...
      	<c:forEach items="${D_clseye}" var="dto">
	      	<tr>
	      		<td>${dto.d_NUM}</td>
	      		<td>${dto.h_NUM}</td>
	      	</tr>
...
<!-- 피부과
<section style="position:absolute; top:380px;left:900px">
      <table border="1">
      	...
      	<c:forEach items="${D_clshskn}" var="dto">
	      	<tr>
	      		<td>${dto.d_NUM}</td>
	      		<td>${dto.h_NUM}</td>
	      	</tr>
